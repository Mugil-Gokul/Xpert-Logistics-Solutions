        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              className="flex flex-col space-y-4"
            >
              <FaGem className="text-red-600 text-4xl" />
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-[#620504] via-red-900 to-black rounded-lg py-10 px-6 lg:px-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-white"
          >
            ...
            <div className="flex flex-col items-center space-y-2">
              <FaClock className="text-red-400 text-4xl" />
              <h3 className="text-3xl font-bold">20+</h3>
              <p className="text-sm">Years of Experience</p>
            </div>
            <div className="flex flex-col items-center space-y-2">
              <FaUserTie className="text-red-400 text-4xl" />
